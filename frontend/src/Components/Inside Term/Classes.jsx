...
export default function SimpleContainer() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (updateResponse.ok) {
        ...
        setMessage(`Class updated successfully. Class Name: ${updatedClass.name}`);
      ...
      setMessage(error.message || "An error occurred while updating the class.");
    } finally {
      triggerSnackbar();
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("https://gsbgs-backend.vercel.app/api/classes");
      ...
      <Box/>
            ...
            >
                ...
                >
                  ...
                  >
                    ...
                    <Box sx={{ overflow: "auto", height: {xs: 'auto', lg: "50vh"} }}>
                      {categorizedData.friday.map((element, index) => (
                        <Button
                          ...
                          onClick={() =>
                            handleClickOpen(element, element._name)
                          } // Corrected
                        >
                          <Typography
                            variant="h6"
        ...
        >
          <DialogTitle
            ...
            sx={{ fontSize: {xs: '2rem', lg: "3rem"}, textAlign: "center", fontWeight: "bold", marginTop: '5%'}}
          >
            {selectedClassName}
          </DialogTitle>
          <DialogContent>
