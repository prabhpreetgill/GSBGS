    ...
    >
        ...
        {currentTerms.length > 0 ? (
          <Box>
              ...
              >
                <Box>
                    <Typography
                      color="#e7e7e7"
                      fontWeight="bold"
                      sx={{ textShadow: "0px 4px 7px rgba(89, 89, 89, 1)", fontSize: {xs: '2.5rem', lg: '3rem'} }}
                    >
                      {currentTerms[0]._name}
                    </Typography>
                    <Typography fontWeight="bold" color="black" sx={{fontSize: {xs: '2rem', lg: '3rem'} }}>
                      {`${new Date(
            ...
            {prevTerms.length > 0 && (
              <Box sx={{ marginTop: "100px", display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
                  <Typography
                    variant="h2"
                    fontWeight="bold"
                    sx={{ marginBottom: "20px", textAlign: 'center'}}
